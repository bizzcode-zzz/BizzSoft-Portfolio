...
export default function Create({ statuses }) {
    const form = useForm({
        ...
        included_items: [...defaultIncludedItems],
    });
                ...
                <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
                    <div>
                        ...
                        <p className="mt-2 text-sm leading-6 text-gray-400">
                            Add a new BizzSoft script or software product to the
                            catalog.
                        </p>
                    </div>
                ...
                >
                    ...
                    <section className="space-y-6 rounded-xl border border-gray-800 bg-gray-900 p-6">
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                placeholder="Short summary shown in product cards and listings."
                                className="mt-2 w-full resize-none rounded-lg border border-gray-700 bg-gray-950 px-4 py-3 text-white outline-none transition placeholder:text-gray-600 focus:border-blue-500"
                            />
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                placeholder="Describe the product, main features, use cases, and other details."
                                className="mt-2 w-full rounded-lg border border-gray-700 bg-gray-950 px-4 py-3 text-white outline-none transition placeholder:text-gray-600 focus:border-blue-500"
                            />
                            ...
                            <div>
                                ...
                                <div className="relative mt-2">
                                    ...
                                    <input
                                        ...
                                        placeholder="0.00"
                                        className="w-full rounded-lg border border-gray-700 bg-gray-950 py-3 pl-9 pr-4 text-white outline-none transition placeholder:text-gray-600 focus:border-blue-500"
                                    />
                                </div>
                        ...
                        <div>
                            ...
                            <p className="mt-2 text-xs text-gray-500">
                                Link to the hosted live demo or product
                                subdomain.
                            </p>
                        ...
                        <div>
                            ...
                            <div className="mt-2 rounded-lg border border-dashed border-gray-700 bg-gray-950 p-4">
                                <input
                                    id="thumbnail"
                                    type="file"
                                    accept="image/*"
                                ...
                                <p className="mt-3 text-xs text-gray-500">
                                    Recommended product image: 1920 × 1080
                                    (16:9). Maximum 5 MB.
                                </p>
                            </div>
                    ...
                    <section className="space-y-6 rounded-xl border border-gray-800 bg-gray-900 p-6">
                        <div>
                            ...
                            <p className="mt-2 text-sm leading-6 text-gray-400">
                                Technical information shown on the public
                    ...
                    <section className="space-y-6 rounded-xl border border-gray-800 bg-gray-900 p-6">
                        <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
                            <div>
                                ...
                                <p className="mt-2 text-sm leading-6 text-gray-400">
                                    Items the customer receives with this
                                    product.
                                </p>
                            </div>
